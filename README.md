...
- Experiência em reestruturação, padronização e automação de KPIs críticos
- Perfil híbrido: dados + engenharia + produto
- Interesse crescente em **Machine Learning aplicado ao negócio**
...
- Ganhos em:
  ...
  - Tempo para análises exploratórias e uso de IA
